...
class load_sts: public Functionality
{
  private:
    std::string type_name_ = "load_sts";
  ...
  public:
    ...
    struct Data : public FuncComponentBase
    {
		...
		{
		    (void) ucdr_serialize_bool(writer, topic->currently_loading);
		...
		{
		    (void) ucdr_deserialize_bool(reader, &topic->currently_loading);
