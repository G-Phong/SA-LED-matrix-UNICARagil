 ...
 * Name: leaving_parking_rect_left_status
 * ID: 10
 */

class leaving_parking_rect_left_status: public Functionality
{
  private:
    std::string type_name_ = "leaving_parking_rect_left_status";
