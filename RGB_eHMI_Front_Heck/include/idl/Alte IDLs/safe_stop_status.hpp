 ...
 * Name: safe_stop_status
 * ID: 10
 */

class safe_stop_status: public Functionality
{
  private:
    std::string type_name_ = "safe_stop_status";
  ...
  public:
    ...
    struct Data : public FuncComponentBase
    {
		...
		{
		    (void) ucdr_serialize_bool(writer, topic->safe_stop);
		...
		{
		    (void) ucdr_deserialize_bool(reader, &topic->safe_stop);
