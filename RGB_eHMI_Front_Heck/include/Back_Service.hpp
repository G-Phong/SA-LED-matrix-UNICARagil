...
//Include LED Matrix Library by hzeller
            ...
            public:
              ...
              public:
                  sTurRig_sts::Return remoteProcedureCall(sTurRig_sts::Parameter parameter){
                      ...
                      std::string turning_right_path = "../eHMI_symbols/eHMI_streams/WendemanöverMitUZSStream.stream"; //path to .stream file //für Back-Service dann mit Uhrzeigersinn (UZS)!
                ...
                public:
                    sSafSto_sts::Return remoteProcedureCall(sSafSto_sts::Parameter parameter){
                        ...
                        std::string warning_sign_path = "../eHMI_symbols/eHMI_streams/AusrufezeichenWarnungStream.streams"; //Richtung des Gifs ändern
...
//Initialisierungen und Instanziierungen AUSSERHALB der Klasse!
//RGBMatrixController * RGB_Back::rgbController; //wird durch Präprozessor-Direktiven initialisiert
RGBMatrixController * RGB_Back::rgbController = new hzellerController();
...
// Instanziierung der RPC-Garantien (total: 8)
